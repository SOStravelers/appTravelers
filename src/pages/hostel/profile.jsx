...
export default function HostelProfile({ user }) {
  ...
  return (
    <div className="bg-white h-full w-screen py-20 lg:py-24 xl:py-24 px-5 md:pl-80 flex flex-col">
      <OutlinedButton
        ...
        onClick={() => router.push("/hostel/residency-details")}
      />
      <OutlinedButton
        text="Settings"
        onClick={() => router.push("/hostel/settings")}
      />
      <OutlinedButton
        text="Hostel Profile"
        onClick={() => router.push("/hostel/profile-config")}
      />
