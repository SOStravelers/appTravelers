const ServiceInfo = ({ service }) => {
  ...
  // Placeholder for languages if service.languages is not an array or is null/undefined
  ...
  return (
    <div className="mt-4">
      ...
      <div className="flex items-center text-gray-700 text-sm">
        ...
        <span>Idiomas: {service.languages.join(', ')}</span>
      </div>
      {service.reviewsLink && (
        <a href={service.reviewsLink} className="text-blue-600 text-sm mt-2 inline-block">
          Leer reseñas
        </a>
      )}
    </div>
