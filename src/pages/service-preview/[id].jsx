...
const placeholderService = {
  ...
  description: 'Viaja en el tiempo en nuestro Free Tour Rio a Pie por el Centro y Lapa y revive el pasado mientras caminas por las encantadoras calles coloniales de Rio y aprendes sobre los cuatro siglos de historia de la ciudad. Únase a nuestro recorrido para comprender más sobre la...',
  highlightedPoints: [
    {
      type: 'Punto de encuentro',
      location: 'Largo da Carioca - Centro, Rio de Janeiro - RJ, Brasil',
      details: 'Frente a la Torre del Reloj de la Plaza Carioca en camisetas rojas',
...
const placeholderInclusions = [
  ...
  { text: 'Tarifas de entrada al Cristo Redentor, la catedral y el Pan de Azúcar', included: true },
  { text: 'Visitas externos a la escalera de Selarón, el estadio de Maracaná y el Sambódromo', included: true },
...
useEffect(()=>{
  ...
  // const { id } = router.query; // id is not currently used for fetching
    ...
    <div className="mx-auto p-4 md:pl-[240px] py-[60px]">
      <div className="flex flex-col lg:flex-row gap-8 p-2 md:p-8">
        ...
        <div className="flex-1">
          ...
          <InclusionsExclusions inclusions={placeholderInclusions} exclusions={placeholderExclusions} />
          ...
          <Gallery images={service.images} onImageClick={(index) => openCarousel(index)} onViewAllClick={() => openCarousel(0)} />
