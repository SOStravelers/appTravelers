          ...
          <ul>
            {inclusions.map((item, index) => (
              <li key={index} className="flex items-center mb-2">
                {/* Check verde */}
                <span className="mr-2 text-green-600 text-xl flex-shrink-0">
                  ✓
                </span>
                <span className="text-gray-900">{item.name[language]}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="exclusions">
          ...
          <ul>
            {exclusions.map((item, index) => (
              <li key={index} className="flex items-center mb-2">
                {/* Cross roja */}
                <span className="mr-2 text-red-500 text-xl flex-shrink-0">
                  ✕
                </span>
                <span className="text-gray-900">{item.name[language]}</span>
              </li>
