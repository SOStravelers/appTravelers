...
function BookingCard() {
  return (
    <div className="text-negro py-5 px-3 w-full flex flex-col justify-center shadow-xl bg-blanco rounded-2xl">
      <h1
        className={`mb-5 underline font-semibold underline-offset-8 ${mazzard.className}`}
      >
        Upcoming Booking
      </h1>
      <div className="flex justify-between">
        <div
          className={`w-14 h-14 rounded-md flex flex-col items-center justify-center border ${mazzard.className}`}
        >
