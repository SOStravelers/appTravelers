...
<h3 className="mb-2 font-bold text-md ml-4">3.1. Reliable Intermediary:</h3>
<p className="mb-2 ml-4">
...
<h3 className="mb-2 font-bold text-md ml-4">3.3. Assistance and Support:</h3>
<p className="mb-2 ml-4">
...
<h4 className="mb-2 font-bold text-sm ml-8">3.4.1 Fee Negotiation and Visibility:</h4>
...
<h4 className="mb-2 font-bold text-sm ml-8">3.4.2 Secure Payment Processing:</h4>
<p className="mb-2 ml-8">
...
<h4 className="mb-2 font-bold text-sm ml-8">3.4.3 Payments to Workers and Establishments:</h4>
<p className="mb-2 ml-8">
...
<h4 className="mb-2 font-bold text-sm ml-8">3.4.4 Dispute Resolution and Refunds:</h4>
<p className="mb-2 ml-8">
...
<h3 className="mb-2 font-bold text-md ml-4">4.2. Accurate Information:</h3>
<p className="mb-2 ml-4">
...
<h3 className="mb-2 font-bold text-md ml-4">4.3. Respect for the Terms:</h3>
<p className="mb-2 ml-4">
...
<h3 className="mb-2 font-bold text-md ml-4">4.4. Respectful Communication:</h3>
<p className="mb-2 ml-4">
...
<h3 className="mb-2 font-bold text-md ml-4">4.5. Collaboration in Conflict Resolution:</h3>
<p className="mb-2 ml-4">
...
<h3 className="mb-2 font-bold text-md ml-4">11.2. Ownership of User Data:</h3>
<p className="mb-2 ml-4">
...
<h3 className="mb-2 font-bold text-md ml-4">12.1. Simple and Secure Registration:</h3>
<p className="mb-2 ml-4">
...
<h3 className="mb-2 font-bold text-md ml-4">12.2. Deletion of User Account:</h3>
<p className="mb-2 ml-4">
