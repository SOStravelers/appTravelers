  ...
  return (
    <section className="m-2 py-32 mb-16  xl:px-36 xl:ml-32">
      ...
      <p className="mb-2">
        ...
        policies, and any other platform-specific policies. It is important to
        note that these terms constitute a legally binding contract between the
        user and SOS Travelers, so it is essential to read them carefully before
        using our services. If you do not agree with any of the terms, we kindly
      ...
      <p className="mb-2 ml-4">
        ...
        and tourism-related service. It is important to note that workers are
      ...
      <p className="mb-2 ml-8">
        Upon the successful completion of a service, payments to workers and
        establishments will proceed according to the terms agreed upon in direct
        negotiation with each party. These terms, including payment percentages,
      ...
      <p className="mb-2 ml-8">
        ...
        ensuring efficient management of the income generated through the
        platform.
      </p>
      ...
      <p className="mb-2 ml-8">
        ...
        opportunity to rate the service. Any specific issues or disputes should
        be directed to customer support, where each case will be individually
      ...
      <p className="mb-2 ml-8">
        ...
        meet the necessary conditions for the service, the responsibility falls
        on the hostel. SOS Travelers reserves the right to withhold or cancel
        payment to the hostel or worker until the service is correctly completed
      ...
      <p className="mb-2">
        ...
        making a reservation. SOS Travelers retains a commission for the use of
        the platform, calculated based on the total transaction amount. Specific
        details regarding fees and payment procedures can be found in our fee
      ...
      <p className="mb-2">
        ...
        utmost importance to us, and we take measures to protect the information
        you share with us. You can review our{" "}
      ...
      <p className="mb-2">
        ...
        informed of any changes. In the case of significant modifications, we
        will notify you through in-app notifications or via email. It is the
        responsibility of each user to stay informed about updates and changes
      ...
      <p className="mb-2">
        ...
        <Link
          href={"mailto:sostravelbr@gmail.com"}
          className="underline text-newBlue"
        >
          sostravelbr@gmail.com
        </Link>
        . We are available to answer your questions, address your concerns, and
        provide efficient assistance. Furthermore, we understand that
        disagreements or disputes may occasionally arise between users, workers,
        and establishments on our platform. To address these issues, we have
        established that the official means of dispute resolution will be
